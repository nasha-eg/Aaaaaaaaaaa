  ...
  return (
    <section id="المصنع" className="py-32 bg-white text-black relative">
      ...
      <div className="max-w-7xl mx-auto px-6">
        <div className={`flex flex-col lg:flex-row justify-between items-end mb-24 gap-12 ${lang === 'ar' ? 'text-right' : 'text-left'}`}>
          <div>
